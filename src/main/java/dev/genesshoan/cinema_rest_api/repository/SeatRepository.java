 ...
 * 
 * <p>Provides data access methods for seat management including
 * retrieval of seat maps for showtimes.</p>
 * 
 * @see Seat
 */
public interface SeatRepository extends JpaRepository<Seat, Long> {
   ...
   * @return List of seats sorted by row number (ascending) and seat number (ascending)
   */
